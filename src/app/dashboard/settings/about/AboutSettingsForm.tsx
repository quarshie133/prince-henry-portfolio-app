      ...
      <form action={handleSubmit} className="space-y-6">
        <div className="space-y-2">
          ...
          <textarea 
            ...
            rows={8} 
            className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-transparent focus:ring-2 focus:ring-black dark:focus:ring-white outline-none leading-relaxed resize-y font-serif"

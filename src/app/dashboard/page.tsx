...
export default async function DashboardOverview() {
  ...
  try {
    ...
    [totalPoetry, totalStories, publishedPosts, drafts] = await Promise.all([
      ...
      prisma.post.count({ where: { type: { in: ['story', 'article'] } } }),
  ...
  const stats = [
    ...
    { title: "Stories & Articles", value: totalStories, icon: "FileText", color: "from-emerald-500/20 to-teal-500/20", textColor: "text-emerald-500" },

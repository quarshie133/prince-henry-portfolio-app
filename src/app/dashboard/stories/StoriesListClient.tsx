            ...
            {posts.map(post => (
              <motion.tr key={post.id} variants={itemVariants} className="group hover:bg-gray-50 dark:hover:bg-[#0a0a0a]/50 transition-colors">
                ...
                <td className="px-6 py-4 text-right flex justify-end gap-2">
                  <Link href={`/dashboard/stories/edit/${post.id}`} className="p-2 text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all opacity-0 group-hover:opacity-100 focus:opacity-100">
                    <Pencil size={16} />
                  </Link>
              ...
              <tr>
                <td colSpan={4} className="px-6 py-16 text-center">
                  <div className="flex flex-col items-center justify-center text-gray-500 space-y-2">
                    ...
                    <p className="text-sm">Start writing your first one!</p>
                  </div>
                </td>
              </tr>
            )}
